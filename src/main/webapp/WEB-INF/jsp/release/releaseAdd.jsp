...
<body>
	...
	<div class="container"">
		...
		<form action="releaseChecklist.do">
			<input type="hidden" name="op" value="addRelease" /> <label>Name:</label>
			<input name="name" placeholder="Release Name" /><label>QA Stable Deploy Date:</label>
			<input id="qaStableDate" name="qaStableDate" placeholder="QA Stable Date" /><label>Stage Deploy Date:</label>
			<input id="stageDate" name="stageDate" placeholder="Stage Date" /><label>Prod Deploy Date:</label>
			<input id="prodDate" name="prodDate" placeholder="Prod Date" />
			...
			<br />
			<button id="createNewReleaseButton" class="btn btn-large btn btn-success" type="submit">Create
				New Release</button>
		</form>
	</div>
